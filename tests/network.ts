...
// import {registerAsSource} from "./instructions/network/registerAsSource"
...
//   try { 
//     await rep_program.account.reputationData.fetch(data); 
//     throw("Not deleted")
//   }catch(error) {
...
//     const authority = new anchor.web3.Keypair()
//     // const repData  = await rep_program.account.reputationData.fetch(data);
//     const {registerAsSourceTx,sourceData} = await registerAsSource(payer.payer.publicKey,authority.publicKey,data);
//     const repData  = await rep_program.account.reputationData.fetch(data);
//     const srcData  = await rep_program.account.sourceData.fetch(sourceData);
//     console.log(`Registered Network as source link: ${registerAsSourceTx}`);
//     console.log(`Source name is: ${srcData}`);
